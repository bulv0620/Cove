...
const resources = [
  ...
  },
  {
    ...
    module: 'workspace',
    name: 'Notes',
    description: 'WYSIWYG Markdown notes stored as plain files on the SMB home.',
    icon: 'NotebookPen',
    sortOrder: 20,
  },
  {
...
const permissions = [
  ...
  {
    id: '30000000-0000-7000-8000-000000000006',
    code: 'workspace.notes.page',
    resourceCode: 'workspace.notes',
    action: 'page',
    name: 'Notes',
    description: 'Access the notes page.',
    type: PermissionType.PAGE,
    parentCode: null,
    sortOrder: 10,
  },
  {
    code: 'workspace.notes.create',
    resourceCode: 'workspace.notes',
    action: 'create',
    name: 'Create notes and folders',
    type: PermissionType.ACTION,
    parentCode: 'workspace.notes.page',
    sortOrder: 20,
  },
  {
    code: 'workspace.notes.update',
    resourceCode: 'workspace.notes',
    action: 'update',
  ...
  {
    code: 'workspace.notes.rename',
    resourceCode: 'workspace.notes',
    action: 'rename',
    name: 'Rename notes and folders',
    type: PermissionType.ACTION,
    parentCode: 'workspace.notes.page',
    sortOrder: 40,
  },
  {
    code: 'workspace.notes.delete',
    resourceCode: 'workspace.notes',
    action: 'delete',
    name: 'Delete notes and empty folders',
    type: PermissionType.ACTION,
    parentCode: 'workspace.notes.page',
    sortOrder: 50,
  },
